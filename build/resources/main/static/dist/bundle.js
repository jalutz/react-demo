...
/***/ function(module, exports, __webpack_require__) {
	...
	var _products = __webpack_require__(208);

	var _products2 = _interopRequireDefault(_products);

	var _cart = __webpack_require__(209);
	...
	var Main = (function (_React$Component) {
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(Storefront, { name: this.state.name });
	        }
	    }]);
	...
	var Storefront = function Storefront(props) {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'h4',
	            null,
	            'Welcome to the React Store Front, ',
	            props.name,
	            '!'
	        ),
	        _react2.default.createElement(
	            'h4',
	            null,
	            'Welcome to the React Store adfasdf, ',
	            props.name,
	            '!'
	        ),
	        _react2.default.createElement(
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { type: 'text', name: 'password', id: 'password' }),
	                    _react2.default.createElement(
	                        'button',
	...
	var ProductList = (function (_React$Component) {
	    ...
	    _createClass(ProductList, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            fetch("/getproducts").then(function (r) {
	                return r.json();
	            }).then(function (data) {
	                _this2.setState({ prods: data });
	        ...
	        value: function render() {
	            ...
	            var productsList = this.state.prods.map(function (product) {
	                var addToCart = _this3.addItemToCart(product).bind(_this3);

	                return _react2.default.createElement(Product, { key: product.productId, product: product });
	            });
	...
	var Product = function Product(props) {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            "td",
	            null,
	            _react2.default.createElement("img", { height: "107", width: "113", src: props.product.productPath, alt: "" })
	        ),
	        _react2.default.createElement(
	            "td",
	            null,
	        ...
	        _react2.default.createElement(
	            "td",
	            null,
	            _react2.default.createElement("input", { type: "button", value: "Add Item" })
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = (function (_React$Component) {
	    ...
	    _createClass(Cart, [{
	        key: "render",
	        value: function render() {
	            var productList = this.state.prods.map(function (product) {
	                return _react2.default.createElement(CartItem, { key: product.productId, product: product });
	            });
